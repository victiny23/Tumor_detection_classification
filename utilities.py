...
class DataGenerator(tf.keras.utils.Sequence):
  def __init__(self, ids , mask, image_dir = 'C:/Users/Victiny/Python_Project/Data_brain_tumor/', batch_size = 16, img_h = 256, img_w = 256, shuffle = True):
  ...
  def __data_generation(self, list_ids, list_mask):
    ...
    for i in range(len(list_ids)):
      #path of the image
      img_path = 'C:/Users/Victiny/Python_Project/Data_brain_tumor/' + str(list_ids[i])
      
      #mask path
      mask_path = 'C:/Users/Victiny/Python_Project/Data_brain_tumor/' + str(list_mask[i])
...
class DataGeneratorClassify(tf.keras.utils.Sequence):
  def __init__(self, ids , mask, image_dir = 'C:/Users/Victiny/Python_Project/Data_brain_tumor/', batch_size = 16, img_h = 256, img_w = 256, shuffle = True):
...
def prediction_all(test, model, model_seg):
  '''
...
def segmentation(test, model_seg):
  '''
